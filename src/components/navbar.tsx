...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="w-full border-b border-gray-700 px-6 md:px-10 md:py-4 py-6 flex items-center justify-between text-xs tracking-[0.35px] relative bg-black">
      <Logo />
