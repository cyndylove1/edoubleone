      ...
      <div className="max-w-7xl mx-auto overflow-x-auto scrollbar-thin scrollbar-thumb-neutral-800 scrollbar-track-transparent pb-6">
        <div className="flex space-x-6 min-w-max">
          {cardData.map((card) => (
            <div
              key={card.id}
              className="w-[340px] md:w-[300px] h-[400px] md:h-[450px] bg-[#0D0D0F] border border-[#1F1F21] rounded-[20px] p-8 flex flex-col justify-between shadow-xl shrink-0 transition-transform duration-300 hover:border-[#333338]"
            >
