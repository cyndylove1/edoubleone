...
const Features: React.FC = () => {
  return (
    <section className="w-full bg-[#121115] border border-[#26252B] text-white px-4 md:px-10 mx-4 py-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mx-4 md:m-10">
